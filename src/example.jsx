    ...
    <div className="bg-gray-900 min-h-screen ">
      <header className="absolute inset-x-0 top-0 z-50">
        ...
        <Dialog open={mobileMenuOpen} onClose={setMobileMenuOpen} className="lg:hidden">
          ...
          <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full max-w-sm bg-gray-900 p-6 sm:ring-1 sm:ring-white/10 overflow-y-auto">
      ...
      <div className="relative isolate px-6 pt-24 lg:px-8">
        ...
        >
          <div
            ...
            className="relative left-1/2 w-[36rem] -translate-x-1/2 bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:w-[72rem]"
          />
        </div>
      </div>
    </div>
